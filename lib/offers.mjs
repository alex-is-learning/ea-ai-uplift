...
.offer-row-meta,.offer-row-benefit{font-size:13.5px; color:var(--ink-2)}
.offer-nonprofit-rows{grid-template-columns:minmax(0,1fr)}
...
function nonprofitRow(o, esc, escAttr) {
  return `        <li class="offer-row" data-offer="${escAttr(o.slug)}">
          <span class="offer-row-meta">${esc(o.by)}</span>
          <a class="offer-row-name" href="${escAttr(o.url)}" rel="noopener">${esc(o.name)}</a>
          <span class="offer-row-benefit">${esc(o.summary)}</span>
          <span class="offer-row-meta">Checked ${esc(longDate(o.checked))}</span>
        </li>`;
}
...
function nonprofitGroup({ items, esc, escAttr }) {
  ...
  return `      <section class="offer-group offer-group-nonprofit-discount" aria-labelledby="offer-group-nonprofit-discount-title">
        ...
        <ul class="offer-rows offer-nonprofit-rows">
