...
import * as assessOrg from './assess-org.mjs';
import * as pathway from './pathway.mjs';
import * as caseStudies from './case-studies.mjs';
import * as contribute from './contribute.mjs';

export const sections = { asks, offers, guides, assess, assessOrg, pathway, caseStudies, contribute };
export const navOrder = ['people', 'asks', 'offers', 'assess', 'guides', 'case-studies'];
