...
.home-robot{display:block; width:100%; max-width:390px; height:auto; aspect-ratio:5/3; margin:28px auto 0; flex:none; overflow:hidden}
...
@media (min-width:861px) and (max-height:700px){
  ...
  .home-copy{height:calc(100svh - 158px)}
  .home-copy h1,.home-copy .lede{flex-shrink:0}
  .home-robot{width:100%; max-width:316px; height:190px; min-height:80px; flex-shrink:1; margin-top:18px}
}
