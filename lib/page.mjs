...
const FOOTER_FINE = 'Maintained by <a href="https://alexanderlarge.com">Alexander Large</a> · <a href="https://github.com/alex-is-learning/ea-ai-uplift">GitHub</a>';
...
.home-robot{display:block; width:min(100%,320px); height:158px; margin:auto auto 0; flex:none; overflow:hidden}
.home-robot .robot-line{fill:none; stroke:var(--ink); stroke-width:2.5; stroke-linecap:round; stroke-linejoin:round; vector-effect:non-scaling-stroke}
.home-robot .signal-line{fill:none; stroke:var(--tang); stroke-width:2; stroke-linecap:round; vector-effect:non-scaling-stroke}
.home-robot .robot-fill{fill:rgba(23,24,28,.045); stroke:var(--ink); stroke-width:2.5; vector-effect:non-scaling-stroke}
.home-robot .robot-eye-blue,.home-robot .bulb-blue{fill:var(--cobalt)}
.home-robot .robot-eye-orange,.home-robot .bulb-orange{fill:var(--tang)}
...
@media (max-width:860px){
  ...
  .home-robot{width:min(86%,300px); height:auto; margin:22px auto 0}
