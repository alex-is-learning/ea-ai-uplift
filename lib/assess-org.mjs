...
const ANSWERS = {
  ...
  usageMix: [
    [1, 'None: 0% are regular or power users'],
    [2, 'Concentrated: 1–20% are regular or power users; almost everyone else rarely or never uses it'],
    [3, 'Emerging: 21–49% are regular or power users; the rest are occasional users or non-users'],
    [4, 'Broad: 50–79% are regular or power users; the rest are occasional users or non-users'],
    [5, 'Routine: 80–100% are regular or power users; the rest are occasional users or non-users'],
    [0, 'Not sure'],
  ],
  confidence: [
...
const PLACES = [
  { n: 3, title: 'Find out first', because: 'Three or more conditions Not sure, or a sight gap.' },
  { n: 5, title: 'Running it, keep it running', because: 'Production 5, Ownership 5, Rules 3 or more.' },
  { n: 1, title: 'Accounts, no practice', because: 'Access 4 or 5, and Rules 3 or more, and Reach and Production each 1 or 2, and Spread 0, 1 or 2.' },
  { n: 4, title: 'One process everyone names', because: 'blocked (Q9) is Yes, and Access or Rules is 3 or more.' },
  { n: 2, title: 'One clear gap', because: 'Otherwise. The result names one condition and its edge or middle line.' },
];
...
export function pages(ctx) {
  return assessmentPages(ctx, {
    ...
    connectives: {
      ...
      blocked: { route: { title: 'Post an ask on Help wanted', href: ctx.site.askFormUrl, local: false } },
