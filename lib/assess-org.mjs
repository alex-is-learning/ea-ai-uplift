...
const ANSWERS = {
  ...
  usageMix: [
    [1, 'None: almost nobody uses it for real work'],
    ...
    [4, 'Broad: 50–79% are regular or power users; most others use it occasionally'],
    [5, 'Routine: 80–100% are regular or power users; most others use it occasionally'],
    [0, 'Not sure'],
  ],
  confidence: [
