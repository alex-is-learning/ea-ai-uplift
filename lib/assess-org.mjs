...
const ANSWER_KINDS = ['count', 'document', 'yesno'];
const KEY = /^[a-z]+$/u;
const POSITIONING = [
...
const ANSWERS = {
  count: [[1, 'Nobody'], [2, 'Fewer than four in ten'], [3, 'Four to six in ten'], [4, 'More than six in ten'], [5, 'Everyone'], [0, 'Not sure']],
  document: [
    [1, 'Does not exist'],
...
const PLACES = [
  { n: 3, title: 'Find out first', because: 'Three or more conditions are not known, or the reported spread is wider than the work the lead can name.' },
  { n: 5, title: 'Running it, keep it running', because: 'A process runs on its own, someone owns the questions, and a current written rule exists.' },
  { n: 1, title: 'Accounts, no practice', because: 'Most staff have bought plans, but the tools do not yet reach systems or scheduled work.' },
  { n: 4, title: 'One process everyone names', because: 'Staff have named a process that is still done by hand, and the organisation has enough access or rules to start.' },
  { n: 2, title: 'One clear gap', because: 'One condition is the clearest place to start.' },
];
