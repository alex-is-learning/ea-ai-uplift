...
export function loadSiteConfig(root) {
  ...
  exactKeys(config, ['askFormUrl', 'offerFormUrl', 'addYourselfFormUrl', 'assessFormUrl', 'caseStudyProposalUrl', 'interviewUrl'], 'data/site.json', errors);
  for (const key of ['askFormUrl', 'offerFormUrl', 'addYourselfFormUrl', 'assessFormUrl', 'caseStudyProposalUrl', 'interviewUrl']) validateHttpsUrl(config?.[key], `data/site.json ${key}`, errors);
