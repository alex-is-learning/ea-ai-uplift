...
function personCard(p, esc, escAttr, prefix) {
  ...
  const frame = p.photo
    ? `<img class="shot" src="${escAttr(prefix)}img/${escAttr(p.photo)}" srcset="${escAttr(prefix)}img/${escAttr(p.slug)}-960.jpg 2x" alt="${escAttr(p.name)}" width="480" height="480" loading="lazy"><span class="wash" aria-hidden="true"></span>`
