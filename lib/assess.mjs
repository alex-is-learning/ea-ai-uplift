    ...
    <div class="wrap">
      ...
      <div class="assess-grid">
        <div class="assess-overview">
          ...
          <p class="assess-fine">${org ? '<b>Staff</b> means paid staff and long-term contractors, including the respondent, not volunteers or trustees. <b>Out of date</b> means not touched in the last twelve months. <b>Regular or power users</b> use AI for real work each week; occasional users use it less often.' : 'No account. Nothing leaves this page unless you save or share the result. The seven ways are a working model from one practitioner, version 0.1, and will change as evidence comes in.'}</p>
