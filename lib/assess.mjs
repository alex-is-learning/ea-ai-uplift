    ...
    <div class="wrap">
      ...
      <div class="assess-grid">
        <div>
          ...
          <p class="assess-fine">${org ? '<b>Staff</b> means paid staff and long-term contractors, including the respondent, not volunteers or trustees. <b>Out of date</b> means not touched in the last twelve months. Count bands are in tenths of staff, so no count sits on a boundary.' : 'No account. Nothing leaves this page unless you choose to send yourself the result. The seven ways are a working model from one practitioner, version 0.1, and will change as evidence comes in.'}</p>
