    ...
    <div class="wrap">
      ...
      <div class="assess-grid">
        <div>
          ...
          <p class="assess-lede">Seven statements about how you work with these tools, then three short questions. Rate each statement as it is today, not as you would like it to be. If a statement describes something you have never met, say so: that is the most useful answer on the page.</p>
