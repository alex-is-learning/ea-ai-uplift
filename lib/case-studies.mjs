  ...
  const body = `  <section class="sub-page" aria-labelledby="case-studies-h1">
    <div class="wrap">
      ...
      <div class="case-method-note">
        ...
        <p><a href="../guides/first-useful-task/">The first useful task</a> shows a method with fictional input and a checked output. It does not show a client outcome.</p>
      </div>
