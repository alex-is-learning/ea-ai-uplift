(function () {
  ...
  function renderQuestion() {
    ...
    var scale = spoke ? DATA.scale : DATA.yesNo;
    var html = '';
    for (var k = 0; k < scale.length; k += 1) {
      ...
      html += '<li' + (value === 0 ? ' class="dk"' : '') + '><button type="button" class="ans' + chosen + '" data-value="' + value + '"><span class="k">' + key + '</span>' + esc(label) + '</button></li>';
    }
