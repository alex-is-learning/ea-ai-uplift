...
${items.map((item) => card(item, esc, escAttr)).join('\n')}
  ...
  const body = `  <section class="sub-page ask-board" aria-labelledby="asks-h1">
    <div class="wrap">
      ...
      <p class="lede">Have a real problem that is slow, repeated or stuck? Post it here. Anyone listed in the <a href="${escAttr(prefix)}people/">people directory</a> can reply.</p>
${board}
      <div class="ask-post">
