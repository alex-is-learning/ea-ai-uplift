  ...
  const routes = [
    {
      ...
      text: 'Send public-ready facts through Tally. A maintainer prepares the listing, and you review the final public text before publication.',
      reply: 'The maintainer uses the public contact URL that you submit.',
      href: site.addYourselfFormUrl,
      label: 'Add your profile',
    },
    {
      title: 'List an offer',
      text: 'Send a public offer through Tally. A maintainer checks its fit and facts before a listing can become public.',
      reply: 'The submitted public offer URL is the form\'s follow-up route.',
    ...
    <div class="wrap">
      ...
      <div class="contribute-notes">
        <div class="contribute-note">
          <h2>Tally proposals</h2>
          <p>The form response goes to the maintainer. An accepted profile or offer becomes public only after review.</p>
        </div>
        <div class="contribute-note">
