# Notices and rights boundary

## Software

The repository's software, including build and quality-check code, is licensed under the MIT License in [LICENSE](LICENSE).

## Editorial content

Original guides and case studies that identify CC BY 4.0 as their licence are available under [LICENSE-CONTENT](LICENSE-CONTENT).
